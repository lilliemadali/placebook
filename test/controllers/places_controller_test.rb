...
class PlacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create place" do
    assert_difference('Place.count') do
      post places_url, params: { place: { full_street_address: @place.full_street_address } }
    end
  ...
  test "should update place" do
    patch place_url(@place), params: { place: { full_street_address: @place.full_street_address } }
